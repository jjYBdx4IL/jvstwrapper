...
enum
{
	...
	effGetParamLabel,	// stuff parameter  label (max 8 char + 0) into string
						// (examples: sec, dB, type)
	effGetParamDisplay,	// stuff parameter  textual representation into string
						// (examples: 0.5, -3, PLATE)
	effGetParamName,	// stuff parameter  label (max 8 char + 0) into string
...
enum
{
	...
	audioMasterPinConnected			// Inquire if an input or output is beeing connected;
									...
									// return value is 0 for  such that older versions
